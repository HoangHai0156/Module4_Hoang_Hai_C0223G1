...
public class CustomerService implements ICustomerService{
    ...
    @Override
    public List<Customer> findAllByFullNameLikeOrAddressLikeOrEmailLikeOrPhoneLike(String name, String address, String email, String phone) {
        return customerRepository.findAllByFullNameLikeOrAddressLikeOrEmailLikeOrPhoneLike(name,address,email,phone);
    }
